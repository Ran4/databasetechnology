...
*/
-- In this case it checks the constraint whether the subject_id (in this case 3443)
--is present as a primary key in subject, which it is not - therefore giving rise to an error.
